...
void init()
{
    ...
    GPIOA->OSPEEDR = 0x0C3C0000; // PA9 and PA10 full speed

    // PLL - STuW81300
    GPIOB->MODER &= ~(GPIO_MODER_MODE3_1 | GPIO_MODER_MODE4_1 | GPIO_MODER_MODE6_1 | GPIO_MODER_MODE7_1 | GPIO_MODER_MODE5_1); // outputs
    GPIOB->MODER &= ~GPIO_MODER_MODE8; // input
