...
void MAX2871_init(void){
    ...
    // Default values
    MAX2871_reg.R0 = 0x80D38000; // 4230 MHz
    MAX2871_reg.R1 = 0x80008011;
    MAX2871_reg.R2 = 0x58011FC2;
    MAX2871_reg.R3 = 0x0100000B;
    MAX2871_reg.R4 = 0x608C8234;
...
int MAX2871_set_frequency(int frequency){
    ...
    N = (frequency<<DIV)/40000;
    FRAC = (((frequency<<DIV)%40000)*4000)/40000;

    freq_out = ((40000*N)+((FRAC*40000)/4000))>>DIV;
