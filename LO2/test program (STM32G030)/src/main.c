...
void init()
{
    ...
    GPIOA->OSPEEDR = 0x0C000000; // PA9 and PA10 full speed

    // PLL - LMX2491
    GPIOB->MODER &= ~(GPIO_MODER_MODE3_1 | GPIO_MODER_MODE4_1 | GPIO_MODER_MODE5_1 | GPIO_MODER_MODE6_1); // outputs
    GPIOB->MODER &= ~GPIO_MODER_MODE7; // input
